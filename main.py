...
mainloop()
# create a stick man anmiction.
# a=int(input('Enter Born Year:'))
...
# check all repsotrites
# ADD A GOAL CALEED LEARN 5 PROGRAMMING LANGUAGE MINNUM 4.
# # CREATE A CALCULATOR,
# # Buy a calling api and text api,
# # complete this project in 2 days.
# # check another age calculators.
# End!
